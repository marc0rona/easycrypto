# Easycrypto Overview
Gestion des adresses de cryptos pour un utilisateur. Va aussi pouvoir gérer une liste de contactes qui va être connecté à un utilisateur.
...
## Tasks
- [ ] Complete student_Readmefile.md
- [ ] Create SRS
- [ ] Create ADRs
- [ ] Start /code folder
